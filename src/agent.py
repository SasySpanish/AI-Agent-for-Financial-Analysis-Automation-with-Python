...
def main():
    ...
    print("\nFase 3: Calcolo indicatori tecnici...")
    feature_files = {}
    ...
    for ticker, clean_path in cleaned_files.items():
        ...
        if os.path.exists(feat_path):
            ...
            print(f"    Features non trovate per {ticker} → uso cleaned")
    
    # Fase 4: Mini-grafici per il report
    print("\nFase 4: Creazione mini-grafici per summary...")
...
### Miglioramenti: 
  ...
  # Estensione + comprensione ticker
  # Nomi ai ticker 
  # Provare con longchain